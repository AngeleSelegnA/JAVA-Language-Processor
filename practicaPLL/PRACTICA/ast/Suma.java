...
public class Suma extends ExpBinaria {
	...
	public Suma(Exp op1, Exp op2, int fila, int col) {
		super(op1,op2);  
		this.fila=fila;
		this.columna=col;
	}     
	...
	public TExp tipoExp() {return TExp.SUMA;}
   
	public String toString() {
        return "suma("+ op1().toString() + "," + op2().toString() + ")";
	}
	...
	public TTipo chequea(){
        ...
        if(tipo1==TTipo.INT && tipo2==TTipo.INT){
            ...
            GestionErroresExp.errorSemantico(this.getFila(),this.getCol(),"Error de tipos en la expresión Suma");
            return null;
        }
    }
